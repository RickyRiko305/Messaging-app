...
public class AllUsersActivity extends AppCompatActivity {
            ...
            protected void populateViewHolder(AllUsersViewHolder viewHolder, AllUsers model, final int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent profileIntent = new Intent(AllUsersActivity.this , profile1Activity.class);
    ...
    public static class AllUsersViewHolder extends RecyclerView.ViewHolder
    {
        ...
        {
            TextView name = (TextView) mView.findViewById(R.id.all_users_status);
            name.setText(user_status);
        }
...
//            Picasso.get().load(user_thumb_image).placeholder(R.drawable.default_profile_image).into(thumb_image);
            Picasso.get().load(user_thumb_image).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.default_profile_image)

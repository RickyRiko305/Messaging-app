    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getUserDataReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
//                    Picasso.get().load(image).placeholder(R.drawable.default_profile_image).into(settingsDisplayProfileImage);
                    Picasso.get().load(image).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.default_profile_image)
        ...
        settingsChangeStatusButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                statusIntent.putExtra("user_status1",old_status);
                                        ...
                                        getUserDataReference.updateChildren(update_user_data)
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        Toast.makeText(SettingsActivity.this, "Image has been uploaded successfully", Toast.LENGTH_SHORT).show();
                                                        loadingBar.dismiss();
